...
*/
  ...
  define('MODULE_NAVBAR_SHOPPING_CART_CONTENTS', '<i class="fa fa-fw fa-shopping-cart"></i> %s producto(s) <span class="caret"></span>');
  define('MODULE_NAVBAR_SHOPPING_CART_NO_CONTENTS', '<i class="fa fa-fw fa-shopping-cart"></i> 0 productos');
  define('MODULE_NAVBAR_SHOPPING_CART_HAS_CONTENTS', '%s producto(s), %s');
  define('MODULE_NAVBAR_SHOPPING_CART_VIEW_CART', 'Ver Carrito');
  define('MODULE_NAVBAR_SHOPPING_CART_CHECKOUT', '<i class="fa fa-fw fa-angle-right"></i> Realizar Pedido');
