			...
			<thead>
				<tr class="dataTableHeadingRow">
					...
					<th class="dataTableHeadingContent"><?php echo TABLE_HEADING_FIRSTNAME; ?></th>
                                        <!--PWA guest checkout-->
                                        <th class="dataTableHeadingContent" align="right"><?php echo constant('MODULE_CONTENT_PWA_GUEST_' . strtoupper($language)); ?></th>
...
<!--PWA guest checkout-->
                <td class="dataTableContent" align="right"><?php echo $customers['customers_guest'] == '1' ? tep_image('images/icons/tick.gif') : ''; ?></td>
