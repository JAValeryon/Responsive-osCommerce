...
?>
  ...
  <div class="form-group row">
    <label for="matc" class="col-form-label col-sm-3 text-left text-sm-right"></label>
    <div class="col-sm-9">
      <?php
      echo tep_draw_checkbox_field('matc', '', false, 'required id="matc"') .  sprintf(MATC_TEXT, tep_href_link('privacy.php', tep_get_all_get_params(), 'SSL')) ;
      ?>
    </div>
  </div>  
