...
<div class="contentContainer">
  ...
  <div class="form-group row">
    <label for="matc" class="col-sm-3 col-form-label text-right"></label>
    <div class="col-sm-9">
      <?php
      echo tep_draw_checkbox_field('matc', '', false, 'id="matc" required') .  sprintf(MATC_TEXT, tep_href_link('privacy.php', tep_get_all_get_params(), 'SSL')) ;
      ?>
    </div>
  </div>      
