...
*/
  ...
  require('create_order/form_check.js.php'); ?>
...
<?php
  ...
  require('create_order/create_order_details.php');
?>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
        <tr>
          <td class="main"><?php echo tep_draw_button(IMAGE_BACK, 'triangle-1-w', tep_href_link('index.php', '', 'SSL'), 'primary'); ?></td>
