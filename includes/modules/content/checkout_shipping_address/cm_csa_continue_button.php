...
*/
  ...
  class cm_csa_continue_button {
    ...
    function __construct() {
      ...
      $this->title = MODULE_CONTENT_CHECKOUT_SHIPPING_ADDRESS_CONTINUE_BUTTON_TITLE;
      $this->description = MODULE_CONTENT_CHECKOUT_SHIPPING_ADDRESS_CONTINUE_BUTTON_DESCRIPTION;
      $this->description .= '<div class="secWarning">' . MODULE_CONTENT_BOOTSTRAP_ROW_DESCRIPTION . '</div>';

      if ( defined('MODULE_CONTENT_CHECKOUT_SHIPPING_ADDRESS_CONTINUE_BUTTON_STATUS') ) {
        $this->sort_order = MODULE_CONTENT_CHECKOUT_SHIPPING_ADDRESS_CONTINUE_BUTTON_SORT_ORDER;
        $this->enabled = (MODULE_CONTENT_CHECKOUT_SHIPPING_ADDRESS_CONTINUE_BUTTON_STATUS == 'True');
      }
    }
    ...
    function check() {
      return defined('MODULE_CONTENT_CHECKOUT_SHIPPING_ADDRESS_CONTINUE_BUTTON_STATUS');
    }
