...
?>
      <div class="col-sm-4">
        <div class="panel panel-<?php echo ($addresses['address_book_id'] == $sendto) ? 'primary' : 'default'; ?>">
          ...
          <div class="panel-footer text-center"><?php echo tep_draw_radio_field_css('address','class="radio2x"', $addresses['address_book_id'], ($addresses['address_book_id'] == $sendto)); ?></div>
        </div>
      </div>
