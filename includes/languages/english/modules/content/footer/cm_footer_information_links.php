...
*/
  ...
  define('MODULE_CONTENT_FOOTER_INFORMATION_LEGAL_NOTICE', 'Legal Notice');
  define('MODULE_CONTENT_FOOTER_INFORMATION_PRIVACY', 'Privacy Policy');
  define('MODULE_CONTENT_FOOTER_INFORMATION_COOKIES', 'Cookie Policy');
