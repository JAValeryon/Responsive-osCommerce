...
define('JS_TELEPHONE', '* The \'Telephone Number\' entry must have at least ' . ENTRY_TELEPHONE_MIN_LENGTH . ' numbers.\n');
//define('JS_TELEPHONE_MOVIL', '* The \'Mobile Number\' entry must have at least ' . ENTRY_TELEPHONE_MOVIL_MIN_LENGTH . ' numbers.\n');
...
define('ENTRY_FIRST_NAME_ERROR', '&nbsp;<small><span style="color: #FF0000">min ' . ENTRY_FIRST_NAME_MIN_LENGTH . ' chars</span></small>');
define('ENTRY_FIRST_NAME_TEXT', '&nbsp;');
define('ENTRY_LAST_NAME', 'Last Name:');
define('ENTRY_LAST_NAME_ERROR', '&nbsp;<small><span style="color: #FF0000">min ' . ENTRY_LAST_NAME_MIN_LENGTH . ' chars</span></small>');
define('ENTRY_LAST_NAME_TEXT', '&nbsp;');
define('ENTRY_DATE_OF_BIRTH', 'Date of Birth:');
define('ENTRY_DATE_OF_BIRTH_ERROR', '&nbsp;<small><span style="color: #FF0000">(eg. 05/21/1970)</span></small>');
define('ENTRY_DATE_OF_BIRTH_TEXT', '&nbsp;<small>(eg. 05/21/1970) ');
define('ENTRY_EMAIL_ADDRESS', 'E-Mail Address:');
define('ENTRY_EMAIL_ADDRESS_ERROR', '&nbsp;<small><span style="color: #FF0000">min ' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . ' chars</span></small>');
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR', '&nbsp;<small><span style="color: #FF0000">Your email address doesn\'t appear to be valid!</span></small>');
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', '&nbsp;<small><span style="color: #FF0000">email address already exists!</span></small>');
define('ENTRY_EMAIL_ADDRESS_TEXT', '&nbsp;');
define('ENTRY_STREET_ADDRESS', 'Street Address:');
define('ENTRY_STREET_ADDRESS_ERROR', '&nbsp;<small><span style="color: #FF0000">min ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' chars</span></small>');
define('ENTRY_STREET_ADDRESS_TEXT', '&nbsp;');
define('ENTRY_SUBURB', 'Suburb:');
define('ENTRY_SUBURB_ERROR', '');
define('ENTRY_SUBURB_TEXT', '');
define('ENTRY_POST_CODE', 'Post Code:');
define('ENTRY_POST_CODE_ERROR', '&nbsp;<small><span style="color: #FF0000">min ' . ENTRY_POSTCODE_MIN_LENGTH . ' numbers</span></small>');
define('ENTRY_POST_CODE_TEXT', '&nbsp;');
define('ENTRY_CITY', 'Suburb:');
define('ENTRY_CITY_ERROR', '&nbsp;<small><span style="color: #FF0000">min ' . ENTRY_CITY_MIN_LENGTH . ' chars</span></small>');
...
define('ENTRY_TELEPHONE_NUMBER_ERROR', '&nbsp;<small><span style="color: #FF0000">min ' . ENTRY_TELEPHONE_MIN_LENGTH . ' numbers</span></small>');
define('ENTRY_TELEPHONE_NUMBER_TEXT', '&nbsp;');
define('ENTRY_TELEPHONE_MOVIL_NUMBER', 'Movil:');
//define('ENTRY_TELEPHONE_MOVIL_NUMBER_ERROR', '&nbsp;<small><span style="color: #FF0000">min ' . ENTRY_TELEPHONE_MOVIL_MIN_LENGTH . ' numbers</span></small>');
...
define('ENTRY_PASSWORD_ERROR', '&nbsp;<small><span style="color: #FF0000">min ' . ENTRY_PASSWORD_MIN_LENGTH . ' chars</span></small>');
