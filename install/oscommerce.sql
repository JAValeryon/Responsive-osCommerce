...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Primary Currency Converter', 'PRIMARY_CURRENCY_SERVER', 'xe', 'Primary currency converter.<br>Fixer requires sign up for access key.', '1', '22', 'tep_cfg_select_option(array(\'fcc\', \'xe\', \'fixer\'),',now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Backup Currency Converter', 'BACKUP_CURRENCY_SERVER', 'fcc', 'Backup currency converter different from Primary.<br>Fixer requires sign up for access key.', '1', '23', 'tep_cfg_select_option(array(\'fcc\', \'xe\', \'fixer\'),',now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Fixer.io access key', 'FIXER_ACCESS_KEY', '', 'Fixer.io currency converter access key', '1', '24', now());
