...
button_retrieve_live_credentials = Recuperar credenciales reales (Live)
button_retrieve_sandbox_credentials = Recuperar credenciales de prueba (Sandbox)
...
update_available_body = <p>¡Hay una actualización para esta App!</p>
