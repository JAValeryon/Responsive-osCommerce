...
*/
  ...
  define('MODULE_CONTENT_CHECKOUT_SHIPPING_SHIPPING_ADDRESS_TITLE', 'Shipping Address');
  define('MODULE_CONTENT_CHECKOUT_SHIPPING_SHIPPING_ADDRESS_DESCRIPTION', 'Shows the Shipping Address on the Checkout Shipping Page.');
