...
?>
  <div class="panel panel-success module-downloads">
    <div class="panel-heading"><strong><?php echo HEADING_DOWNLOAD; ?></strong></div>
...
?>
      ...
      <p><?php printf(str_replace('\'', '', FOOTER_DOWNLOAD), '<a class="btn btn-success" role="button" href="' . tep_href_link('account.php', '', 'SSL') . '">' . HEADER_TITLE_MY_ACCOUNT . '</a>'); ?></p>
