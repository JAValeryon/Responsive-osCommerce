    ...
    <td class="main"><table border="0" width="100%" cellspacing="0" cellpadding="2" class="formArea">
      <tr>
        <td class="main"><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main" width="130">&nbsp;<?php echo ENTRY_CUSTOMERS_ID; ?></td>
  ...
  <tr>
    <td class="main"><table border="0" width="100%" cellspacing="0" cellpadding="2" class="formArea">
      <tr>
        <td class="main"><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main" width="130">&nbsp;<?php echo ENTRY_ACCOUNT_PASSWORD; ?></td>
            <td class="main">&nbsp;<?php echo tep_draw_input_field('customers_password', '', 'id="customers_password"') . '&nbsp;' . ENTRY_ACCOUNT_PASSWORD_TEXT; ?> </td>
          </tr>
          <tr>
            <td class="main" width="130">&nbsp;<?php echo ENTRY_NEWSLETTER_SUBSCRIBE; ?></td>
      ...
      <tr>
        <td class="main"><table border="0" width="100%" cellspacing="0" cellpadding="2" class="formArea">
          <tr>
            <td class="main"><table border="0" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main" width="130">&nbsp;<?php echo ENTRY_CURRENCY; ?></td>
