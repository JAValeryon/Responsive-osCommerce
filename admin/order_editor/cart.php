...
*/
  ...
  class manualCart {
    ...
    function restore_contents($orders_id) {
      ...
      $products_query = tep_db_query("select products_id, products_quantity from orders_products where orders_id = '" . (int)$orders_id . "'");
...
// products price
        $product_query = tep_db_query("select products_id, products_price, products_tax_class_id, products_weight from products where products_id='" . tep_get_prid($products_id) . "'");
